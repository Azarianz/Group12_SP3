...
bool CMenuState::Init(void)
{
	...
	settingButtonData.fileName = "Image\\GUI\\OptionButton.png";
...
bool CMenuState::Update(const double dElapsedTime)
{
	...
	// 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
	{
		...
		// Add codes for Settings button here
			...
			ImVec2(buttonWidth, buttonHeight), ImVec2(0.0, 0.0), ImVec2(1.0, 1.0)))
		{
			...
			// Load the menu state
			cout << "Loading SettingMenuState" << endl;
			CGameStateManager::GetInstance()->SetActiveGameState("SettingMenuState");
		}
