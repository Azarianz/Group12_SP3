...
bool CPet2D::Init(void)
{
	...
	if (cMap2D->FindValue(400, uiRow, uiCol) == false)
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/Assets/cat.tga", true);
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/Assets/cat.tga" << endl;
		return false;
	}
 ...
 */
void CPet2D::Update(const double dElapsedTime)
{
	if (!bIsActive)
		return;
...
*/
void CPet2D::Seti32vec2Index(const int iIndex_XAxis, const int iIndex_YAxis)
{
...
*/
void CPet2D::Seti32vec2NumMicroSteps(const int iNumMicroSteps_XAxis, const int iNumMicroSteps_YAxis)
{
 ...
 */
void CPet2D::SetPlayer2D(CPlayer2D* cPlayer2D)
{
 ...
 */
void CPet2D::Constraint(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
		if (vec2Index.x < 0)
	...
	{
		cout << "CPet2D::Constraint: Unknown direction." << endl;
	}
}
...
/**
 ...
 @param eDirection A DIRECTION enumerated data type which indicates the direction to check
 */
bool CPet2D::CheckPosition(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
	...
	{
		cout << "CPet2D::CheckPosition: Unknown direction." << endl;
	}
 ...
 */
void CPet2D::UpdateDirection(void)
{
 ...
 */
void CPet2D::FlipHorizontalDirection(void)
{
	i32vec2Direction.x *= -1;
}

void CPet2D::FlipVerticalDirection(void)
{
	i32vec2Direction.y *= -1;
}

void CPet2D::FlipRandomDirection(void)
{
...
*/
void CPet2D::UpdatePosition(void)
{
